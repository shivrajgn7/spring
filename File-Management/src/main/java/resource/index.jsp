...
<div style="display: flex; align-items: center; justify-content: center; width: 100vw; background-color: #white">
    <div style="width: 45vw; margin: 20px 0 20px 0; box-shadow: 0px 0px 20px 0px ;background-color:#white">
        <h1 style="color:#00000; text-align:center;font-family: Arial"> Add Your File </h1>

        <h3 style="color:#220643; text-align:center;font-family: Flexport" >Make it Unnique Keep it Safe</h3>


        <form style="padding:50px" action="file" method="post">
    ...
    <a href="Search.jsp">SEARCH</a>
            ...
            <div class="mb-3"  id="formFields87">
                             ...
                             <input type="text" class="form-control" id="exampleFormControlInput76" name="fileName" required placeholder="max 10 characters">
                             </div>
            <div class="mb-3" >
            <label for="exampleFromInput2" class="form-label">Enter file Type</label>
            <select class="form-select" id="inputGroupSelect02" name="fileType" required>
                    ...
                    <div class="mb-3"  id="formFields4">
                                            ...
                                            <input type="text" class="form-control" id="exampleFormControlInput5" name="fileSize" required placeholder="min kb max gb">
                                        </div>
                     <div class="mb-3"  id="formFields5">
                                            <label for="exampleFormControlInput1" class="form-label">Enter file Uique number</label>
                                            <input type="text" class="form-control" id="exampleFormControlInput6" name="fileNumber" required placeholder=" only 4 numbers allowed">
                  </div>
                   <div class="mb-3"  id="formFields5">
                           <input type="submit" class="form-control" id="exampleFormControlInput6">
                       </div>
                 </form>
        </div>
        </div>
